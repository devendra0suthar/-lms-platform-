...
const courses = [
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        title: "Figma Basics - Getting Started",
      ...
      },
      {
        ...
        videoUrl: "https://www.youtube.com/watch?v=QrNi9FmdlxY"
      },
      {
        title: "Creating Wireframes & Prototypes",
      ...
      questions: [
        {
          ...
          options: ["User Extra", "User Experience", "Ultra Experience", "User Experiment"],
          correctAnswer: 1
        },
        {
